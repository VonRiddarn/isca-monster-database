...
function renderMonsterCards(arrayToRender) {
    ...
    for (const monster of arrayToRender) {
        ...
        // DELETE / EDIT buttons
        const deleteEditSpan = monsterCard.appendChild(
            document.createElement("span")
        );

        const deleteButton = deleteEditSpan.appendChild(
        ...
        const editButton = deleteEditSpan.appendChild(
            document.createElement("button")
        );
        ...
        // SAVE / CANCEL buttons
        const saveCancelSpan = monsterCard.appendChild(
            document.createElement("span")
        );
        saveCancelSpan.style = "display: none;";

        const saveButton = saveCancelSpan.appendChild(
            document.createElement("button")
        );
        ...
        const cancelButton = saveCancelSpan.appendChild(
            document.createElement("button")
        );
        cancelButton.addEventListener("click", (e) => {
            ...
            console.warn(
                "EDIT BUTTON CURRENTLY DELETES MONSTER - ADD FUNCTION TO EDIT!!!"
            );
        });
        ...
        const monsterAlias = monsterProfile.appendChild(
        ...
        // create list item containing the "attitude" or alignment
        const alignment = document.createElement("p");
        alignment.className = "monster-hostility";
        alignment.innerHTML = `Attitude: ${monster.monsterHostility}`;
        monsterProfile.appendChild(alignment);
